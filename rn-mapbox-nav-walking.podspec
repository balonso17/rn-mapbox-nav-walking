...
Pod::Spec.new do |s|
  s.name         = "rn-mapbox-nav-walking"
  s.version      = package["version"]
  s.summary      = package["description"]
  s.description  = <<-DESC
                  Smart Mapbox turn-by-turn routing based on real-time traffic for React Native.
                   DESC
  s.homepage     = "https://github.com/balonso17/rn-mapbox-navigation-walking.git"
  s.license    = { :type => "MIT", :file => "LICENSE" }
  s.authors      = { "HOMEE" => "support@homee.com" }
  s.platforms    = { :ios => "11.0" }
  s.source       = { :git => "https://github.com/balonso17/rn-mapbox-navigation-walking.git", :tag => "#{s.version}" }
